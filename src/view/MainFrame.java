...
public class MainFrame extends javax.swing.JFrame {
    ...
    public void adaugaStudent() {
        ...
        if (MainService.getInstance().existaStudent(cnp)) {
            JOptionPane.showMessageDialog(this, "Studentul exista!");
        } else {
            Student student = new Student(nume, prenume, cnp);
            MainService.getInstance().adaugaStudent(student);
            afisareStudenti();
        }
    ...
    private void afisareStudenti() {
        List<Student> studenti = MainService.getInstance().getStudenti();
        model.clear();
        studenti.forEach(model::addElement);
    }
    
    private void deleteStudent(int id) {
        MainService.getInstance().deleteStudent(id);
    }
